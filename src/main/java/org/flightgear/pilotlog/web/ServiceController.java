...
public class ServiceController {
    ...
    public DurationTotalsAwarePage<Flight> flights(
        ...
        Page<Flight> page;
        page = flightService.findFlightsByExample(example, pageable);
        return new DurationTotalsAwarePage<>(page.getContent(),
                pageable,
                page.getTotalElements(),
                flightService.getTotalFlightTimeByExample(example)
        );
    }
    ...
    public Page<Aircraft> aircraft(
            @PageableDefault(sort = "totalFlights", direction = DESC) Pageable pageable
    ) {
        return aircraftService.findAllAircraft(pageable);
    }
